                ...
                <table class="table invoice-items">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $data[0]->total_price/$item->price }}</td>
                            <td class="text-center">{{ $data[0]->total_price }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
{{-- <section role="main" class="content-body">
    <div class="panel-body">
        <div class="invoice">
            <header class="clearfix">
                <div class="row">
                    <div class="col-sm-6 mt-md">
                        <h2
                            class="h2 mt-none mb-sm text-dark text-bold"
                        >
                            INVOICE
                        </h2>
                        <h4
                            class="h4 m-none text-dark text-bold"
                        >
                            #76598345
                        </h4>
                    </div>
                    <div
                        class="col-sm-6 text-right mt-md mb-md"
                    >
                        <address class="ib mr-xlg">
                            Okler Themes Ltd
                            <br />
                            24 Henrietta Street, London,
                            England
                            <br />
                            Phone: +12 3 4567-8901
                            <br />
            ...
            <div class="bill-info">
                <div class="row">
                    <div class="col-md-6">
                        <div class="bill-to">
                            <p
                                class="h5 mb-xs text-dark text-semibold"
                            >
                                To:
                            </p>
                            <address>
        ...
        <div class="text-right mr-lg">
            ...
            >
            <a
                href="pages-invoice-print.html"
                target="_blank"
                class="btn btn-primary ml-sm"
